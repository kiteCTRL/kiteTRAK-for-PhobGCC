...
namespace pico_ssd1306 {
    ...
    void SSD1306::sendBuffer() {
        ...
        // send data to device
        i2c_write_blocking(this->i2CInst, this->address, data, FRAMEBUFFER_SIZE + 1, true); // false by default
    }
    ...
    void SSD1306::cmd(unsigned char command) {
        ...
        i2c_write_blocking(this->i2CInst, this->address, data, 2, true); // false by default
    }
